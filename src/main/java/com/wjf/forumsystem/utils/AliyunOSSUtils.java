...
public class AliyunOSSUtils {
    ...
    private static final String ACCESS_KEY_ID="LTAI5tLSNtVVFnvFCZNBX9w7";
    private static final String ACCESS_KEY_SECRET="QtywfijWiUhJBWcsdqXpfFEfnWiyif";
    //EnvironmentVariableCredentialsProvider credentialsProvider = CredentialsProviderFactory.newEnvironmentVariableCredentialsProvider();
    // 填写Bucket名称，例如examplebucket。
    private static final String BUCKENAME = "formu-system";
